...
let end_pred_inj = { p_name = "end"; p_type = [occurrence_type; event_type] ; p_prop = 0; p_info = [] }
let end2_pred = { p_name = "end2"; p_type = [event_type;event_type]; p_prop = 0; p_info = [] }

let begin_pred = { p_name = "begin"; p_type = [event_type]; p_prop = pred_BLOCKING; p_info = [] }
let begin_pred_inj = { p_name = "begin"; p_type = [event_type;occurrence_type]; p_prop = pred_BLOCKING; p_info = [] }
let begin2_pred = { p_name = "begin2"; p_type = [event_type;event_type]; p_prop = pred_BLOCKING; p_info = [] }
