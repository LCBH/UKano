...
let rec unfold_gint t = function
  | 0 -> t
  | n -> PGFunApp(("+", parse_extent()), [unfold_gint t (n-1)]), parse_extent()
...
|       gterm LEQ gterm
        { Param.has_integer := true; PGFunApp(("<=", parse_extent()), [$1; $3]), parse_extent() }
|       gterm GEQ gterm
        { Param.has_integer := true; PGFunApp((">=", parse_extent()), [$1; $3]), parse_extent() }
|       gterm LESS gterm
        { Param.has_integer := true; PGFunApp(("<", parse_extent()), [$1; $3]), parse_extent() }
...
|       GET IDENT LPAREN tpatternseq RPAREN options optinprocess optelseprocess
        { PGet($2, $4, None, $7, $8,$6), parse_extent() }
|       GET IDENT LPAREN tpatternseq RPAREN SUCHTHAT pterm options optinprocess optelseprocess
        { PGet($2, $4, Some $7, $9, $10,$8), parse_extent() }
